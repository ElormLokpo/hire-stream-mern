...
export const RecruiterRegisterForm = () => {
    ...
    return <div className="p-2 w-[23rem]">
        ...
        <form onSubmit={handleSubmit(handleSubmitForm)}>
            ...
            <p className="text-center dark:text-white text-[0.7rem] mt-3">Already have an account? <Link to={recruiterRoutes.AUTH_LOGIN} className="text-indigo-500 underline">Login here</Link></p>
        </form>
    </div>
}