...
export const AuthLoginForm = () => {
    ...
    return <div className="p-2 w-[23rem]">
        ...
        <form onSubmit={handleSubmit(handleSubmitForm)}>
            ...
            <p className="text-center dark:text-white text-[0.7rem] mt-3">Don't have an account? <Link to={recruiterRoutes.AUTH_REGISTER} className="text-indigo-500 underline">Register here</Link></p>
        </form>
    </div>
}